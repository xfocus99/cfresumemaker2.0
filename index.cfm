	...
	<div class="card-pattern">
		...
		<div id="home">
			<div class="clr">
				<div class="top-bg">
					<div class="top-left" >
						...
						<div class="tag">HELLO, <span>I'M <cfoutput>#basicinfo.fullname#</cfoutput>,</span></div>
			...
			<div class="clr">
				...
				<div class="special">
					Copying other people's stuff and making it *somewhat* better.
				</div>
			</div>
			<div class="clr">
				<div>
